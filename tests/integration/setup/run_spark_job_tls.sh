...
echo "Run Spark job"
spark-client.spark-submit --username hello --conf spark.hadoop.fs.s3a.connection.ssl.enabled=true spark.kubernetes.executor.request.cores=0.1 --conf --class org.apache.spark.examples.SparkPi local:///opt/spark/examples/jars/spark-examples_2.12-3.4.1.jar 100
set +e